...
import { getCurrentCoordinates } from "../actions/covidActions";
                  ...
                  <div class="main">
                    <div class="app-wrapper mb-4 ">
                      ...
                      {primaryProfile.office
                        .filter((o) => o.allow_waiting_room)
                        .map((o) => (
                          <div
                            class="visited-list d-flex align-items-center"
                            onClick={(e) => {
                              e.preventDefault();
                              dispatch(getCurrentOffice(o.slug));
                              history.push(`/office/${o.slug}/checkin`);
                            }}
                          >
                            <div class="profile">
                      ...
                      <Link to="/dashboard/add-office">
                        <div class="visited-list d-flex align-items-center some-one-else">
                          <div class="profile">
